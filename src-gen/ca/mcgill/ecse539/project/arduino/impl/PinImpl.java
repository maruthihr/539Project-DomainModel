 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.ecse539.project.arduino.impl.PinImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link ca.mcgill.ecse539.project.arduino.impl.PinImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PinImpl extends MinimalEObjectImpl.Container implements Pin {
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.PIN__DIRECTION, oldDirection,
					direction));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.PIN__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ArduinoPackage.PIN__DIRECTION:
			return getDirection();
		case ArduinoPackage.PIN__NAME:
			return getName();
		}
