 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.ecse539.project.arduino.impl.LoopImpl#getInstruction <em>Instruction</em>}</li>
 *   <li>{@link ca.mcgill.ecse539.project.arduino.impl.LoopImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoopImpl extends MinimalEObjectImpl.Container implements Loop {
	 ...
	 * @ordered
	 */
	protected static final String NAME_EDEFAULT = "Loop";
	...
	public EList<Instruction> getInstruction() {
		if (instruction == null) {
			instruction = new EObjectContainmentEList<Instruction>(Instruction.class, this,
					ArduinoPackage.LOOP__INSTRUCTION);
		}
		return instruction;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ArduinoPackage.LOOP__INSTRUCTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ArduinoPackage.LOOP__NAME:
			return getName();
		}
